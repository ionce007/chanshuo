...
import { Button, Input, InputNumber, Layout, message as Message, Popconfirm, Select, Space, Switch, Modal } from 'antd';
    ...
    return (
      <div>
        <Space direction='vertical'>
          链接<Input placeholder='页面链接' name='link' value={this.state.page.link} onChange={this.onInputChange} />
          密码<Input placeholder='阅读密码' name='password' value={this.state.page.password} onChange={this.onInputChange} />
          类型<Select style={{ width: '100%' }} label='页面类型' name='type' options={PAGE_OPTIONS} value={this.state.page.type} placeholder='页面类型' onChange={this.onTypeChange} />
          <br />
          <Space>
            <Switch name='commentStatus' label='允许评论' checked={this.state.page.commentStatus === 1} onChange={this.onCommentStatusChange} />{' '}
            允许评论
          </Space>
          <Space>
            <Switch name='pageStatus' label='发布页面' checked={this.state.page.pageStatus !== 0} onChange={this.onPublishStatusChange} />{' '}
            发布页面
          </Space>
          <Space>
            <Switch name='pageStatus' label='置顶页面' checked={this.state.page.pageStatus === 2} onChange={this.onStayOnTopStatusChange} />{' '}
            置顶页面
          </Space>
          <Space>
            <Switch name='pageStatus' label='Hide on index' checked={this.state.page.pageStatus === 3} onChange={this.onHiddenStatusChange} />{' '}
            隐藏页面
          </Space>
          {/*<Space>*/}
          {/*  <Switch*/}
          ...
          <br />
          <Space>
            <Popconfirm title={'确认删除页面？'} onConfirm={() => { this.deletePage(); }} okText='确认' cancelText='取消'>
              <Button type='primary' danger size={'small'} disabled={this.state.isNewPage}>删除</Button>
            </Popconfirm>
            <Popconfirm title={'确认重置页面？'} onConfirm={() => { this.reset(); }} okText='确认' cancelText='取消'>
          ...
          <br />
          编程语言
          <Select style={{ width: '100%' }} label='编程语言' name='language' options={languages} value={this.state.language} placeholder='编程语言' onChange={this.onLanguageChange} />
          颜色主题
          <Select style={{ width: '100%' }} label='颜色主题' name='theme' options={themes} value={this.state.theme} placeholder='颜色主题' onChange={this.onThemeChange} />
          字体大小
          <InputNumber style={{ width: '100%' }} placeholder='字体大小' name='font_size' type='number' min='1' value={this.state.fontSize} onChange={this.onFontSizeChange} />
        </Space>
      </div>
    );
  }
